...
3. This software (FLRW Metric Tensor Calculator):
   @software{Einsteinpy_to_latex2026,
       author = {P. Ntelis},
       title = {Einsteinpy_to_latex: FLRW Metric Tensor Calculator},
       year = {2026},
...
__github_repo__ = "https://github.com/lontelis/Einsteinpy_to_latex"
...
def print_citation():
    ...
    [3] P. Ntelis (2026). Einsteinpy_to_latex: FLRW Metric Tensor 
...
def generate_bib_file():
    ...
    bib_content = """% BibTeX citations for Einsteinpy_to_latex project (FLRW Metric)
...
filename = "einsteinpy_to_latex.tex"
with open(filename, "w") as f:
    ...
    f.write("% GitHub: https://github.com/lontelis/Einsteinpy_to_latex\n")
    ...
    f.write("\\item P. Ntelis (2026). Einsteinpy\\_to\\_latex: FLRW Metric Tensor Calculator (Version 1.0).\n")
